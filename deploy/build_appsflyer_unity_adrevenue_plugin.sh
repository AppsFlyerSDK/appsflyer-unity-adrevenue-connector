...
echo "Start Build for appsflyer-unity-adrevenue-plugin.unitypackage"

DEPLOY_PATH=outputs
UNITY_PATH="/Applications/Unity/Unity.app/Contents/MacOS/Unity"
PACKAGE_NAME="appsflyer-unity-adrevenue-plugin-6.2.2.unitypackage"
mkdir -p $DEPLOY_PATH
...
-quit \
&& echo "package exported successfully to outputs/appsflyer-unity-adrevenue-plugin-6.2.2.unitypackage" \
